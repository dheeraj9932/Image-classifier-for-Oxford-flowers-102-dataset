...
model.add(Conv2D(32, kernel_size=7, strides=1, activation='relu', input_shape=(image_height, image_width, 3)))
#model.add(Conv2D(32, kernel_size=7, strides =1, activation='relu'))
...
df.to_csv(r'./sravani_arch_cm.csv', sep='\t', encoding='utf-8', header='true')

df2 = pandas.DataFrame(class_rep).transpose()
df2.to_csv(r'./sravani_arch_cr.csv', sep='\t', encoding='utf-8', header='true')

# #############################################################################################
# Save the model
model.save('./checkpoints3/sravani_arch_cr_model')

# Save the weights
model.save_weights('./checkpoints3/sravani_arch_cr_weights')
