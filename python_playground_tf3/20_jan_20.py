...
# ############################################################################################################
model = Sequential()
model.add(Conv2D(32, kernel_size=3, strides=1, activation='relu', input_shape=(image_height, image_width, 3)))
...
df.to_csv(r'/media/dheeraj/HDD/crnt/OVGU/sem 2/computer vision and deep learning/assignments/flower_project/python_playground_tf3/20_jan_20_confmat.csv')
print(conf_mat)

print('Classification Report')
class_rep = classification_report(validation_generator.classes, y_pred)
df2 = pandas.DataFrame(class_rep).transpose()
df2.to_csv(r'/media/dheeraj/HDD/crnt/OVGU/sem 2/computer vision and deep learning/assignments/flower_project/python_playground_tf3/20_jan_20_classrep.csv')
print(class_rep)
